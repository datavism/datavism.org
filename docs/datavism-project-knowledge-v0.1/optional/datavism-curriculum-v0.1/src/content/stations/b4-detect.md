...
status: "locked"
teaser: "Finding peaks, patterns, repetitions, anomalies or engagement signals."
sources: []
missionMinutes: 90
ghostFragment:
  - "B4 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Signal Report for BITE / Feeds & Behavior."
  steps:
...
> **Role in line:** Analysis: find peaks, patterns, repetitions, anomalies or engagement signals.  
> **Artifact:** Signal Report

## Core Question

What rhythm, anomaly or loop does the feed reveal?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **DETECT** in the DATAVISM Evidence Engine;
- apply the method: **Signal detection in behavioral and content data.**;
...
> Finding peaks, patterns, repetitions, anomalies or engagement signals.
