...
status: "locked"
teaser: "Explaining a platform, feed or behavior dynamic as public evidence."
sources: []
missionMinutes: 90
ghostFragment:
  - "B5 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Feed Autopsy Case File for BITE / Feeds & Behavior."
  steps:
    ...
    - "Package the result as: Feed Autopsy Case File."
selfChecks:
  - "I can explain what B5 teaches."
  - "I can show the source material or evidence trail."
  - "I can mark what is verified, uncertain or still missing."
artifactName: "Feed Autopsy Case File"
nextTeaser: "Continue through the BITE / Feeds & Behavior line."
---
# B5 — FEED AUTOPSY

> **Line:** BITE / Feeds & Behavior  
> **Line motto:** Decode the feed.  
> **Role in line:** Case File: explain a platform, feed or behavior dynamic as public evidence.  
> **Artifact:** Feed Autopsy Case File

## Core Question

How do we make a feed dynamic visible?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **FEED AUTOPSY** in the DATAVISM Evidence Engine;
- apply the method: **Feed investigation packaging.**;
...
> Explaining a platform, feed or behavior dynamic as public evidence.
