...
status: "locked"
teaser: "Collecting and structuring sources, data and raw material."
sources: []
missionMinutes: 60
ghostFragment:
  - "G3 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Intake Sheet / Mini-Pipeline for GHOST / Foundation."
  steps:
    ...
    - "Package the result as: Intake Sheet / Mini-Pipeline."
selfChecks:
  - "I can explain what G3 teaches."
  - "I can show the source material or evidence trail."
  - "I can mark what is verified, uncertain or still missing."
artifactName: "Intake Sheet / Mini-Pipeline"
nextTeaser: "Continue through the GHOST / Foundation line."
---
# G3 — INTAKE

> **Line:** GHOST / Foundation  
> **Line motto:** Ask better. Command cleaner. Verify harder.  
> **Role in line:** Structure: collect and structure raw material.  
> **Artifact:** Intake Sheet / Mini-Pipeline

## Core Question

What raw material do I need, and how do I structure it?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **INTAKE** in the DATAVISM Evidence Engine;
- apply the method: **Source intake, data structuring and first pipeline thinking.**;
...
> Collecting and structuring sources, data and raw material.
