...
missionMinutes: 90
ghostFragment:
  - "K2 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Tracking Signal Sheet for KEY / Tracking & OSINT."
  steps:
    ...
    - "Package the result as: Tracking Signal Sheet."
selfChecks:
  - "I can explain what K2 teaches."
  - "I can show the source material or evidence trail."
  - "I can mark what is verified, uncertain or still missing."
artifactName: "Tracking Signal Sheet"
...
> **Role in line:** Access: inspect pixels, cookies, SDKs, consent flows and request patterns.  
> **Artifact:** Tracking Signal Sheet

## Core Question

Which technical signals prove that tracking is happening?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **SIGNALS** in the DATAVISM Evidence Engine;
- apply the method: **Tracking signal inspection.**;
...
> Reading pixels, cookies, SDKs, consent flows and request patterns.
