...
status: "locked"
teaser: "Understanding IDs, segments, brokers, profiles and entity resolution."
sources: []
missionMinutes: 90
ghostFragment:
  - "K3 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Identity Graph Sketch for KEY / Tracking & OSINT."
  steps:
    ...
    - "Package the result as: Identity Graph Sketch."
selfChecks:
  - "I can explain what K3 teaches."
  - "I can show the source material or evidence trail."
  - "I can mark what is verified, uncertain or still missing."
artifactName: "Identity Graph Sketch"
...
> **Role in line:** Structure: connect IDs, segments, brokers, profiles and inferred identities.  
> **Artifact:** Identity Graph Sketch

## Core Question

How does a scattered trace become a profile?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **IDENTITY GRAPH** in the DATAVISM Evidence Engine;
- apply the method: **Identity graph reasoning and entity-resolution literacy.**;
...
> Understanding IDs, segments, brokers, profiles and entity resolution.
