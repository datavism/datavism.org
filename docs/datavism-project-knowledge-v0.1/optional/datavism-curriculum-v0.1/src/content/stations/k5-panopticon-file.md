...
status: "locked"
teaser: "Turning a concrete tracking or surveillance structure into public evidence."
sources: []
missionMinutes: 90
ghostFragment:
  - "K5 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Panopticon Case File for KEY / Tracking & OSINT."
  steps:
    ...
    - "Package the result as: Panopticon Case File."
selfChecks:
  - "I can explain what K5 teaches."
  - "I can show the source material or evidence trail."
  - "I can mark what is verified, uncertain or still missing."
artifactName: "Panopticon Case File"
...
> **Role in line:** Case File: document a tracking or surveillance structure as public evidence.  
> **Artifact:** Panopticon Case File

## Core Question

How do we make a surveillance structure visible and verifiable?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **PANOPTICON FILE** in the DATAVISM Evidence Engine;
- apply the method: **Surveillance investigation packaging.**;
...
> Turning a concrete tracking or surveillance structure into public evidence.
