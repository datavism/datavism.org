...
status: "locked"
teaser: "Mapping companies, people, institutions, owners, funders and lobby actors."
sources: []
missionMinutes: 90
ghostFragment:
  - "R2 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Actor Map for ROOK / Economy & Power."
  steps:
...
> **Role in line:** Access: identify companies, people, institutions, owners, funders and lobby actors.  
> **Artifact:** Actor Map

## Core Question

Which actors make the system work?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **ACTORS** in the DATAVISM Evidence Engine;
- apply the method: **Actor mapping and source-backed entity research.**;
...
> Mapping companies, people, institutions, owners, funders and lobby actors.
