...
status: "locked"
teaser: "Structuring money, contracts, ad spend, subsidies, capital or ownership flows."
sources: []
missionMinutes: 90
ghostFragment:
  - "R3 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Flow Table for ROOK / Economy & Power."
  steps:
...
> **Role in line:** Structure: turn money, ownership, contracts or subsidies into analyzable flows.  
> **Artifact:** Flow Table
...
- explain the purpose of **FLOWS** in the DATAVISM Evidence Engine;
- apply the method: **Flow modeling and tabular economic evidence.**;
...
> Structuring money, contracts, ad spend, subsidies, capital or ownership flows.
