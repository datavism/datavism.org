...
status: "locked"
teaser: "Turning an economic power structure into public evidence."
sources: []
missionMinutes: 90
ghostFragment:
  - "R5 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Mammon Case File for ROOK / Economy & Power."
  steps:
...
> **Role in line:** Case File: document an economic power structure as public evidence.  
> **Artifact:** Mammon Case File

## Core Question

How do we make economic power legible?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **MAMMON FILE** in the DATAVISM Evidence Engine;
- apply the method: **Economic investigation packaging.**;
...
> Turning an economic power structure into public evidence.
