...
status: "locked"
teaser: "Finding historical sources, long-term datasets and institutional records."
sources: []
missionMinutes: 90
ghostFragment:
  - "V1 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Archive Map for VESPER / Climate & Future."
  steps:
...
> **Role in line:** Orientation: find historical sources, long-term datasets and institutional records.  
> **Artifact:** Archive Map

## Core Question

Where does the long signal live?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **ARCHIVE** in the DATAVISM Evidence Engine;
- apply the method: **Archive and long-term source discovery.**;
...
> Finding historical sources, long-term datasets and institutional records.
