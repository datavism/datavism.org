...
status: "locked"
teaser: "Reading trends, seasonality, breaks, baselines and long-term movement."
sources: []
missionMinutes: 90
ghostFragment:
  - "V2 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Pattern Sheet for VESPER / Climate & Future."
  steps:
...
> **Role in line:** Structure and analysis: read trends, seasonality, breaks, baselines and movement.  
> **Artifact:** Pattern Sheet

## Core Question

What is changing, what is stable, and what is noise?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **PATTERNS** in the DATAVISM Evidence Engine;
- apply the method: **Longitudinal pattern analysis.**;
...
> Reading trends, seasonality, breaks, baselines and long-term movement.
