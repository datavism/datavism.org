...
status: "locked"
teaser: "Turning a long-system finding into public evidence."
sources: []
missionMinutes: 90
ghostFragment:
  - "V5 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Cumulus Case File for VESPER / Climate & Future."
  steps:
...
> **Role in line:** Case File: turn a long-system finding into public evidence.  
> **Artifact:** Cumulus Case File

## Core Question

How do we make a slow system impossible to ignore?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **CUMULUS FILE** in the DATAVISM Evidence Engine;
- apply the method: **Long-horizon investigation packaging.**;
...
> Turning a long-system finding into public evidence.
