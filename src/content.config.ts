...
// Field works — mirror of the SHIPPED, gauntlet-verified works of the research
// collective Meridian (ADR 002/003, Phase 2). Generated by scripts/field-sync.mjs;
// do not edit by hand: frontmatter is the work's meta.json, the body its README —
// both verbatim. Interactive works carry an empty body and render live in the lab.
const fieldWorks = defineCollection({
  loader: glob({ pattern: '**/*.md', base: './src/content/field-works' }),
  schema: z.object({
    title: z.string(),
    date: z.string(),
    author: z.string(),
...
export const collections = { stations, fieldWorks }
