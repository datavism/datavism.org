...
status: "locked"
teaser: "Collecting feed, stream, event or content data responsibly."
sources: []
missionMinutes: "90 min"
ghostFragment:
  - "B2 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Capture Pipeline for BITE / Feeds & Behavior."
  steps:
...
> **Role in line:** Access: collect feed, stream, event or content data responsibly.  
> **Artifact:** Capture Pipeline

## Core Question

How do we capture the signal without distorting it?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **CAPTURE** in the DATAVISM Evidence Engine;
- apply the method: **Responsible capture pipelines.**;
...
> Collecting feed, stream, event or content data responsibly.
