...
status: "locked"
teaser: "Connecting long-term patterns to affected groups, risks and consequences."
sources: []
missionMinutes: "90 min"
ghostFragment:
  - "V4 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Impact Brief for VESPER / Climate & Future."
  steps:
    ...
    - "Package the result as: Impact Brief."
selfChecks:
  - "I can explain what V4 teaches."
  - "I can show the source material or evidence trail."
  - "I can mark what is verified, uncertain or still missing."
artifactName: "Impact Brief"
nextTeaser: "Continue through the VESPER / Climate & Future line."
---
# V4 — IMPACT

> **Line:** VESPER / Climate & Future  
> **Line motto:** Read the long signal.  
> **Role in line:** Interpretation: connect long-term patterns to affected groups and consequences.  
> **Artifact:** Impact Brief

## Core Question

Who is affected, how, when and with what uncertainty?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **IMPACT** in the DATAVISM Evidence Engine;
- apply the method: **Impact analysis and public-interest framing.**;
...
> Connecting long-term patterns to affected groups, risks and consequences.
