...
status: "locked"
teaser: "Formulating the economic question behind a system."
sources: []
missionMinutes: "90 min"
ghostFragment:
  - "R1 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Money Question Brief for ROOK / Economy & Power."
  steps:
    ...
    - "Package the result as: Money Question Brief."
selfChecks:
  - "I can explain what R1 teaches."
  - "I can show the source material or evidence trail."
  - "I can mark what is verified, uncertain or still missing."
artifactName: "Money Question Brief"
...
> **Role in line:** Orientation: formulate the economic question.  
> **Artifact:** Money Question Brief

## Core Question

Who pays, who profits, and who carries risk?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **LEDGER** in the DATAVISM Evidence Engine;
- apply the method: **Economic question design.**;
...
> Formulating the economic question behind a system.
