...
status: "locked"
teaser: "Cleaning timestamps, categories, duplicates, formats and event structures."
sources: []
missionMinutes: "90 min"
ghostFragment:
  - "B3 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Clean Event Table for BITE / Feeds & Behavior."
  steps:
...
> **Role in line:** Structure: clean timestamps, categories, duplicates, formats and events.  
> **Artifact:** Clean Event Table

## Core Question

What structure makes this stream analyzable?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **NORMALIZE** in the DATAVISM Evidence Engine;
- apply the method: **Event data cleaning and normalization.**;
...
> Cleaning timestamps, categories, duplicates, formats and event structures.
