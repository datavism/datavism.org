...
status: "locked"
teaser: "Working with uncertainty, futures, assumptions and scenario logic."
sources: []
missionMinutes: "90 min"
ghostFragment:
  - "V3 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Scenario Board for VESPER / Climate & Future."
  steps:
...
> **Role in line:** Analysis: work with uncertainty, futures, assumptions and scenario logic.  
> **Artifact:** Scenario Board

## Core Question

What futures are plausible under which assumptions?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **SCENARIOS** in the DATAVISM Evidence Engine;
- apply the method: **Scenario reasoning and uncertainty framing.**;
...
> Working with uncertainty, futures, assumptions and scenario logic.
