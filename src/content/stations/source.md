...
status: "locked"
teaser: "Identifying relevant feeds, platforms, channels, APIs, exports or streams."
sources: []
missionMinutes: "90 min"
ghostFragment:
  - "B1 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Source Inventory for BITE / Feeds & Behavior."
  steps:
...
> **Role in line:** Orientation: identify relevant feeds, platforms, channels, APIs, exports or streams.  
> **Artifact:** Source Inventory

## Core Question

Which feed or stream defines the signal environment?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **SOURCE** in the DATAVISM Evidence Engine;
- apply the method: **Source selection and stream framing.**;
...
> Identifying relevant feeds, platforms, channels, APIs, exports or streams.
