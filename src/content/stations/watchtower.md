...
status: "locked"
teaser: "Monitoring changes, sources, pages, systems or actors with OSINT methods."
sources: []
missionMinutes: "90 min"
ghostFragment:
  - "K4 opens a new part of the Evidence Engine."
  - "This station is a stub. Replace this fragment with the final story beat."
mission:
  goal: "Create a first version of the Watchlist / Monitor for KEY / Tracking & OSINT."
  steps:
...
> **Role in line:** Analysis: monitor changes across sources, pages, policies, datasets or actors.  
> **Artifact:** Watchlist / Monitor

## Core Question

What changes when nobody is looking?

## Learner Outcome

After this station, the learner can:

- explain the purpose of **WATCHTOWER** in the DATAVISM Evidence Engine;
- apply the method: **OSINT monitoring and change detection.**;
...
> Monitoring changes, sources, pages, systems or actors with OSINT methods.
